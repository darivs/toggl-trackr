# toggl-trackr – Product Requirements Document
...
- Arbeitszeitkonto: Summe aller (Ist - Soll) über alle abgeschlossenen Wochen

UI/UX

- Hauptanzeige: Zentriert minimal – Arbeitszeitkonto als riesige Zahl, Wochenstunden klein darunter/daneben
...
- src/utils/hours.ts – Berechnungslogik:
  ...
  - Arbeitszeitkonto = Summe aller Differenzen abgeschlossener Wochen
  - Zeitformatierung: Minuten → h:mm

4 - Frontend – UI-Komponenten

- src/App.tsx – Hauptlayout, Theme-Provider
- src/components/WorkingTimeAccount.tsx – Große Zahl: Arbeitszeitkonto (farbcodiert dezent)
...
1.  pnpm run dev startet Frontend + Backend
2.  Frontend zeigt Arbeitszeitkonto als große Zahl (korrekt berechnet seit Startdatum)
